...
public:
    ...
    // -- Điệu nhảy mở rộng
    void Samba(float steps = 6, int period = 700, int height = 20);       // Điệu Samba
    void Ballet(float steps = 5, int period = 1200, int height = 20);     // Điệu Ballet
    void Hula(float steps = 8, int period = 900, int height = 25);        // Điệu Hula Hawaii
    void Twist(float steps = 6, int period = 600, int height = 20);       // Điệu Twist
    void RobotDance(float steps = 4, int period = 600, int height = 20);  // Điệu Robot
